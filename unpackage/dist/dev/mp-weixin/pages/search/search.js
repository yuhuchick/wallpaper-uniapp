...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const searchData = (data) => {
      api_apis.searchWall(data).then((res) => {
        console.log("res", res);
    ...
    common_vendor.watch(() => queryParams.value.keyword, () => {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        n: common_vendor.f(classList.value, (item, k0, i0) => {
          return {
            a: item.smallPicurl,
            b: common_vendor.o(($event) => navigateTo(item), item._id),
            c: item._id
          };
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c10c040c"], ["__file", "F:/uni-app/wallpaper-app/pages/search/search.vue"]]);
